...
<body onLoad=document.withdraw.accountno.focus()>
<%
...
<form name=withdraw method=post action="http://localhost:9080/ClubBank/Withdraw.jsp">
...
<tr><td align=center>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type=submit name=submit value=submit></td></tr>
</table><br><br>
