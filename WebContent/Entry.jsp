...
<form name=f1 method=post action="http://localhost:9080/ClubBank/Addcustomer.jsp" >
...
<tr><td>Create Password:<td><input type=Password name=pass><label for="cpass">(Maximum 10 characters only)</label></tr>
</table>
</fieldset>
...
<table>
<tr><td align=center><input type=submit value=Submit name=submit onClick= "return check()" ><td>
</table>
<br><h2 align="right">
<a href="http://localhost:9080/ClubBank/Front.jsp">Home</a></h2>
</form>
</body>
</html>