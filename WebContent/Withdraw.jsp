...
result=teller4.calladdwithdraw(amount1,account);
if(result!=0.0 && result>500)
{
%>
<center>
<h1>ClubBank</h1>
<table id=tab>
<tr><td colspan=2>Your WithDraw Transaction:</td></tr>
...
Invalid Account No. OR Account cannot contain less than 500rs.</h2>
 <%
 }
}
%>
<h2 align="right" style="font-family:Comic Sans Ms;color:red;font-size:32px";><a href="http://localhost:9080/ClubBank/WithdrawHtml.jsp">Back</a></h2>
</body>
</html>